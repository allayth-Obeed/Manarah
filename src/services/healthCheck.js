...
// نفس متغير البيئة الذي يقرأه apiClient — بدل نسخة ثامنة مكررة من الرابط الثابت
// ملاحظة: هذا الملف يستخدم fetch الخام عمداً وليس apiClient، لأن الفحص هنا يعتبر 401
// "الباك اند يعمل لكن بدون تسجيل دخول" وليس خطأ جلسة يستدعي إعادة توجيه (كما يفعل apiClient تلقائياً)
